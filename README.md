...
[![Build Status](https://travis-ci.com/pwall567/kjson-test.svg?branch=main)](https://travis-ci.com/pwall567/kjson-test)
...
### Gradle
```groovy
    testImplementation 'io.kjson:kjson-test:1.0'
```
### Gradle (kts)
```kotlin
    testImplementation("io.kjson:kjson-test:1.0")
